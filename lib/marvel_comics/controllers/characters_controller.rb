...
module MarvelComics
  class CharactersController < BaseController
    @@instance = CharactersController.new
    ...
    # @param [String] character_id Required parameter: A single character id.
    # @return Character response from the API call
    def get_character_individual(character_id)
      ...
      if _response.code == 404
        raise APIException.new 'Character not found.', 404, _response.body
      end
      ...
      if _response.body.instance_of? Hash
        begin
          Character.from_hash(_response.body)
        rescue Exception
