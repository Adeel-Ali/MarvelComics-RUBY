...
module MarvelComics
  class EventsController < BaseController
    ...
    # @param [String] event_id Required parameter: A single event.
    # @return Event response from the API call
    def get_event_individual(event_id)
      ...
      if _response.code == 404
        raise APIException.new 'Event not found.', 404, _response.body
      end
      ...
      if _response.body.instance_of? Hash
        begin
          Event.from_hash(_response.body)
        rescue Exception
