...
module MarvelComics
  class SeriesController < BaseController
    ...
    # @param [String] series_id Required parameter: Filter by series title.
    # @return Series response from the API call
    def get_series_individual(series_id)
      ...
      if _response.code == 404
        raise APIException.new 'Series not found.', 404, _response.body
      end
      ...
      if _response.body.instance_of? Hash
        begin
          Series.from_hash(_response.body)
        rescue Exception
