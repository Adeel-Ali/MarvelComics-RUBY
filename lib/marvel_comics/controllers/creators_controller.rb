...
module MarvelComics
  class CreatorsController < BaseController
    @@instance = CreatorsController.new
    ...
    # @param [String] creator_id Required parameter: A single creator id.
    # @return Creator response from the API call
    def get_creator_individual(creator_id)
      ...
      if _response.code == 404
        raise APIException.new 'Creator not found.', 404, _response.body
      end
      ...
      if _response.body.instance_of? Hash
        begin
          Creator.from_hash(_response.body)
        rescue Exception
